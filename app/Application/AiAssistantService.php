...
class AiAssistantService
{
    ...
    public function chat(AiConversation $conversation, string $userMessage): AiMessage
    {
        ...
        // Auto-title on first message and remember the model used for the thread.
        ...
        $tools = $this->toolRegistry->schemas($conversation->user_id, $conversation->company_id);
    ...
    protected function buildSystemPrompt(AiConversation $conversation): string
    {
        return PromptLoader::load('chat-system', [
            'user_name' => 'the current user',
            'company_name' => 'the current company',
